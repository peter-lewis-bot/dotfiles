# Generated by Powerlevel10k configuration wizard on 2022-05-31 at 15:06 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|glgroup|aws-profile'
