...
/usr/libexec/PlistBuddy -c "Set ':New Bookmarks:0:Normal Font' 'MesloLGS-NF-Regular 13'" ~/Library/Preferences/com.googlecode.iterm2.plist 2>/dev/null
/usr/libexec/PlistBuddy -c "Set ':New Bookmarks:0:Non Ascii Font' 'MesloLGS-NF-Regular 12'" ~/Library/Preferences/com.googlecode.iterm2.plist 2>/dev/null
